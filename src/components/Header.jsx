    ...
    return (
        <header className="glass-panel" style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <div>
                    <h1 style={{ fontSize: '1.5rem', fontWeight: '700', lineHeight: 1 }}>
                        Astur<span className="text-gradient">Fly</span>
                    </h1>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.75rem', color: '#94a3b8', marginTop: '0.2rem' }}>
                        <Radio size={12} className="text-gradient" />
                        <span>OVD LIVE TRAFFIC</span>
                    </div>
                </div>
            </div>
